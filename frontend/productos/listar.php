...
<script>
    ...
    $('#confirmDeleteBtn').on('click', function() {
        ...
        fetch(`https://localhost/comercio/backend/productos/delete.php?idProducto=${idProducto}`, {
            method: 'DELETE'
        })
            .then(response => {
                if (response.ok) {
    ...
    function buscarProductos() {
        ...
        const url = new URL('https://localhost/comercio/backend/productos/listar.php');
        const params = {};
                ...
                if (data.length === 0) {
                    ...
                    data.forEach(producto => {
                        ...
                        row.innerHTML = `
                            ...
                            <td>${producto.tipo}</td>
                            <td><img src="https://localhost/comercio/backend/imagenes/${producto.imagen}" alt="${producto.nombre}" width="50"></td>
                            <td>
