...
<div class="container mt-5">
    <h2 class="bg-danger">Crear Pedido Comercio</h2>
    <form id="pedidoForm">
        <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        fetch('https://localhost/comercio/backend/productos/listar.php')
            ...
            .then(data => {
                ...
                data.forEach(producto => {
                    ...
                    option.text = producto.nombre + ' [' + producto.precioEsp + ' $ - ' + producto.tipo + ']';
                    option.dataset.precio = producto.precioEsp;
        ...
        document.getElementById('pedidoForm').addEventListener('submit', function(event) {
            ...
            fetch('https://localhost/comercio/backend/pedidos/create.php', {
                method: 'POST',
                body: formData
            })
                .then(response => response.json())
